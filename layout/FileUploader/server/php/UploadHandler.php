...
class UploadHandler
{
    ...
    protected $image_objects = array();
      ...
      public function __construct($options = null, $initialize = true, $error_messages = null,$DirPath='/images/baby-castle/') {
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            // 'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            // 'upload_url' => $this->get_full_url().'/files/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME') ,4).$DirPath,
            'upload_url' => $this->get_full_upload_url().$DirPath,
    ...
    protected function get_full_upload_url() {
        ...
        return
            ...
            $_SERVER['SERVER_PORT'] === 80 ? '' : ':'.$_SERVER['SERVER_PORT'])))."/baby-castle/layout/"
          ;
    }
